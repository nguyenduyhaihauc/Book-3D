...
function Fireworks() {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      {/* SVG Spritesheet - Ẩn nhưng cần có cho script.js */}
      ...
      <div className="stage-container remove">
        ...
        {/* Hidden controls and menu for script.js initialization - không hiển thị nhưng cần có trong DOM */}
        ...
        <div className="menu" style={{ display: "none" }}>
          <div className="menu__inner-wrap">
            <div className="btn btn--bright close-menu-btn"></div>
            <form>
              ...
              <div className="form-option form-option--checkbox form-option--finale-mode">
                <label className="finale-mode-label">
                  Bắn nhiều pháo hoa cùng lúc
                </label>
              ...
              <div className="form-option form-option--checkbox">
                <label className="long-exposure-label">
                  Giữ vệt sáng pháo hoa
                </label>
