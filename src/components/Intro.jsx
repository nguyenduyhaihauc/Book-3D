...
const TetMemoriesIntro = () => {
  ...
  const NextPage = () => {
    ...
    <div className="w-full h-screen flex items-center justify-center overflow-hidden relative">
      ...
      {/* Overlay để đảm bảo text vẫn đọc được */}
      ...
      <div className="relative z-[2] text-center space-y-4 sm:space-y-6 md:space-y-8 lg:space-y-10 px-4 sm:px-6 md:px-8 max-w-5xl mx-auto">
