  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "text-glow": {
          "0%, 100%": {
            textShadow: "0 0 10px rgba(255, 215, 0, 0.9), 0 0 20px rgba(255, 215, 0, 0.7), 0 0 30px rgba(255, 215, 0, 0.5), 0 0 40px rgba(255, 165, 0, 0.4), 0 0 50px rgba(255, 140, 0, 0.3)",
          },
          "50%": {
            textShadow: "0 0 15px rgba(255, 215, 0, 1), 0 0 30px rgba(255, 215, 0, 0.9), 0 0 45px rgba(255, 215, 0, 0.7), 0 0 60px rgba(255, 165, 0, 0.6), 0 0 80px rgba(255, 140, 0, 0.5)",
          },
        },
        "text-glow-subtle": {
          "0%, 100%": {
